...
writing, anyons have rather strong empirical backing [[cite//b:@Bartolomei2020]].
...
the fundamental spaces being [cite//b:@Fox1962] and [cite//b:@Fadell1962]. Insead of doing
...
I hear you say, "did [cite//b:@Bartolomei2020] not definitively show that anyons
...
indeed appear quite "magical" [cite:@Berry1984]. However, as [cite//b:@Simon1983]
...
experimental results by [cite//b:@Bartolomei2020]. Evaluating the merits of the
...
*************** TODO Put this somewhere else, preferably at the end
    ...
    - Following [cite//b:@Norton2012], we know how to interpret this: we can demote an
      idealization to an approximation if we are able to show that there is a
      smooth limit.
    - This is exactly the problem, according to [cite//b:@Shech2019:] the topological explanation of anyons requires an /exact/ 2D system (or a rather ad-hoc 2D system as we saw).
    - Therefore we cannot call this approximately 2D.
    - According to [cite//b:@Shech2019], this is a problem for those with nominalist inclinations[fn:1], as the instantiation of abstract mathematical structures in the real world would be an issue.
...
[cite//b:@Tong2016[[]]] for a quite accessible and to [cite//b:@Arovas2020] for a more
thorough pedagogical discussion of these issues, and to
[cite//b:@Stone1992],Prange1987,Doucot2005 for rather complete, less pedagogical
sources.
...
The trick is: do not compute the wave function, just write one down. That is exactly what text[cite//b:@Laughlin1983] did, yielding what we now call the *Laughlin wavefunction*
...
The quantum hall effect has also been studied in three dimensions, see [cite//b:@Torres2020],Tang2019,Pavlosiuk2017.
...
[fn:5] Improved performance of impure 2D materials is an active area of research in material science, see [cite//b:@Wang2020] for a summary of how impurities enhance the conductivity of graphene.
